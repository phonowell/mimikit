...
- @create_task 时，和代码无关的简单任务使用 profile="standard"，需要编程或复杂任务使用 profile="specialist"；在 prompt 中清晰描述任务需求；在 title 中提供简洁摘要。
...
// 环境信息；供参考，不主动提及
<MIMIKIT:environment>
- now_iso: 2026-02-11T08:50:49.012Z
- now_local: 2/11/2026, 4:50:49 PM
