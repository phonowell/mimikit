...
test('resolveRoundFollowup still rejects advisory-only follow-up when multiple active plans exist but exactly one is structurally anchored to the finished task', async () => {
