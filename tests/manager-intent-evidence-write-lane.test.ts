...
test.each([
  {
    ...
    planId: 'plan-auth-guard-continuation-lane-shift',
  ...
  },
  {
    ...
    planId: 'plan-auth-guard-continuation-lane-alias-only',
  ...
  'enqueue_task(write) stays blocked when the active continuation target rewrites the execution lane $caseName',
  ({ executionSpecId, input, planId, taskKey }) => {
