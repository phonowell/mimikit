...
test('shouldTriggerMemoryRefresh returns false when turn gap met but no delta exists', async () => {
  ...
  runtime.process.manager.turn = 40
  runtime.process.manager.memoryRefresh.lastCompletedTurn = 20
  runtime.process.manager.memoryRefresh.signalVersion = 1
  runtime.process.manager.memoryRefresh.lastProcessedSignalVersion = 1
...
test('shouldTriggerMemoryRefresh returns true when turn gap met and delta exists', async () => {
  ...
  runtime.process.manager.turn = 40
  runtime.process.manager.memoryRefresh.lastCompletedTurn = 20
  runtime.process.manager.memoryRefresh.signalVersion = 2
  runtime.process.manager.memoryRefresh.lastProcessedSignalVersion = 1
