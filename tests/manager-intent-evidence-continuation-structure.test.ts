...
test('enqueue_task stays allowed when a single active plan is the only current continuation target even if wording shifts heavily', () => {
...
test('enqueue_task stays allowed when a single result task is the only current continuation target even if wording shifts heavily', () => {
