...
const elements = {
  ...
  toolsResetWithSummaryBtn: $('[data-tools-reset-with-summary]'),
  ...
  summaryResetDialog: $('[data-summary-reset-dialog]'),
  summaryResetCancelBtn: $('[data-summary-reset-cancel]'),
  summaryResetConfirmBtn: $('[data-summary-reset-confirm]'),
...
bindRestart({
  ...
  toolsResetWithSummaryBtn: elements.toolsResetWithSummaryBtn,
  ...
  summaryResetDialog: elements.summaryResetDialog,
  summaryResetCancelBtn: elements.summaryResetCancelBtn,
  summaryResetConfirmBtn: elements.summaryResetConfirmBtn,
